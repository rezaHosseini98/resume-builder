      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert in resume writing. Your task is to enhance the professional summary of a resume.The summary should be 1-2 sentences also highlighting key skills, experience, and career objectives. Make it compelling and ATS-friendly. and only return text no option or anything else.",
        },
        {
          role: "user",
          content: userContent,
...
// controller for uploading a  resumes to the database
