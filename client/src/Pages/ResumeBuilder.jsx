        ...
        <div className=" grid lg:grid-cols-12 gap-8">
          ...
          <div className=" relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className=" bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              {/* Progress bur using activeSectionIndex  */}
              ...
              <div className=" flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                {/* Template and ColorPicker Selector */}
                ...
                <div className=" flex items-center">
                    ...
                    <button
                      onClick={() =>
                        setActiveSectionIndex(
                          (prevIndex) => Math.max(prevIndex - 1),
                          0
                        )
                      }
                  ...
                  <button
                    onClick={() =>
                      setActiveSectionIndex(
                        (prevIndex) => Math.min(prevIndex + 1),
                        sections.length - 1
                      )
                    }
                    className={` flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${
            ...
            <div className=" relative w-full">
              <div className=" absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center p-2 px-4 gap-2 text-xs bg-linear-to-br from-green-100 to-green-200 text-green-600 ring-green-300 rounded-lg hover:ring transition-colors"
                >
